...
contact_info =
  contact:
    ...
    name_0_c : people[userQuery] + 'C'
    name_1_c : people[userQuery] + 'surnameC'
  billing:
    name_0_b : people[userQuery] + 'B'
    name_1_b : people[userQuery] + 'surnameB'
    address_0_b : 'test address line 1 B'
    address_1_b : 'test address line 2 B'
    company_b: 'TEST COMPANY B'
    vatid_b : 'test vat id'
  shipping:
    name_0_s : people[userQuery] + 'S'
    name_1_s : people[userQuery] + 'surnameS'
